...
urlpatterns = patterns('',
    ...
    url(r'^hacknight/$', views.hacknight, name='hacknight'),
    url(r'^partner/$', views.partner, name='partner'),
    url(r'^press/$', views.press, name='press'),
    url(r'^tech/$', views.tech, name='tech'),
    url(r'^back_end_fellowship/$', views.backEndFellowship, name='back_end_fellowship'),
    url(r'^front_end_fellowship/$', views.frontEndFellowship, name='front_end_fellowship'),     
    ...
    url(r'^board_chair/$', views.board_chair, name='board_chair'),
